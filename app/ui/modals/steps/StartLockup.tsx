            ...
            <DialogContent className="bg-neutral-900 bg-[linear-gradient(90deg,#171717_43%,#292929_43%)] rounded-[10px] border-none w-[894px] p-12">
                <div className="flex flex-row gap-12">
                    <div className="w-[336px]">
                        <DialogTitle className="text-[32px] not-italic font-bold leading-[120%] tracking-[-0.4px] pb-4">Final Approval</DialogTitle>
                        <LockupSteper />
                    </div>
                    <div className="w-[375px] flex flex-col gap-6">
                        ...
                        <Button variant="secondary" className="w-full h-[63px] hover:bg-neutral-900 hover:text-white hover:border hover:border-white rounded-[10px] text-[#080815] text-center text-xl not-italic font-medium leading-[21px]">
                            Start Lock Up
                        </Button>
                    </div>
                </div>
