...
export const EditLockupDuration = ({ lockup, onEditLockup }: EditLockupDurationProps) => {
        ...
        <Dialog>
            ...
            <DialogContent className="bg-neutral-900 rounded-[10px] border-none w-[698px] p-12">
                <DialogHeader className="pb-[34px]">
                    <DialogTitle className="text-[32px] not-italic font-bold leading-[120%] tracking-[-0.4px] mb-[10px]">Edit Lockup Duration</DialogTitle>
                </DialogHeader>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-5 mt-5 [&>*:last-child]:mt-[30px]">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <div className="gap-[56px] flex justify-start items-center">
                                        <FormLabel className="text-sm not-italic font-normal leading-[120%] opacity-60 w-[100px]">New Lockup Time:</FormLabel>
                                        <FormControl>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <div className="flex items-center gap-[56px]">
                                        <FormLabel className="text-sm not-italic font-normal leading-[120%] opacity-60 w-[100px]">stATOMs:</FormLabel>
                                        <p className="text-[#646464] text-xl not-italic font-medium leading-[21px]">{field.value}</p>
                                    </div>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <div className="flex items-center gap-[56px]">
                                        <FormLabel className="text-sm not-italic font-normal leading-[120%] opacity-60 w-[100px]">Updated Voting Power:</FormLabel>
                                        <p className="text-xl not-italic font-medium leading-[21px]">{field.value}</p>
                                    </div>
                                    <FormMessage />
                                </FormItem>
                            )}
