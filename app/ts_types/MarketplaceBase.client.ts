...
import type {
  ...
  ListingResponse,
  ListingsResponse,
  ListingsByCollectionResponse,
  ListingsByOwnerResponse,
  WhitelistedCollectionsResponse,
} from "./MarketplaceBase.types"
...
export class MarketplaceBaseQueryClient
  implements MarketplaceBaseReadOnlyInterface
{
  ...
  whitelistedCollections =
    async (): Promise<WhitelistedCollectionsResponse> => {
      return this.client.queryContractSmart(this.contractAddress, {
...
export interface MarketplaceBaseInterface
  extends MarketplaceBaseReadOnlyInterface {
  contractAddress: string
  sender: string
  buy: (
    {
...
export class MarketplaceBaseClient
  extends MarketplaceBaseQueryClient
  implements MarketplaceBaseInterface
{
