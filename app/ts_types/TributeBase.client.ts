...
import type {
  ConfigResponse,
  HistoricalTributeClaimsResponse,
  Coin,
  OutstandingLockupClaimableCoinsResponse,
  OutstandingTributeClaimsResponse,
  ProposalTributesResponse,
  RoundTributesResponse,
} from "./TributeBase.types"
...
export class TributeBaseQueryClient implements TributeBaseReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.outstandingLockupClaimableCoins =
      this.outstandingLockupClaimableCoins.bind(this)
  }
...
export class TributeBaseClient
  extends TributeBaseQueryClient
  implements TributeBaseInterface
{
