...
import {
    ...
    QueryMsg,
    RoundEndResponse,
    RoundProposalsResponse,
    RoundTotalVotingPowerResponse,
    TopNProposalsResponse,
    ...
    UserVoteResponse,
    VoteWithPower,
    UserVotingPowerResponse,
    Addr,
    WhitelistAdminsResponse,
    WhitelistResponse,
} from "./HydroBase.types"
export interface HydroBaseReadOnlyInterface {
    ...
    roundEnd: ({ roundId }: { roundId: number }) => Promise<RoundEndResponse>
...
export class HydroBaseClient
    extends HydroBaseQueryClient
    implements HydroBaseInterface
{
    ...
    constructor(
        ...
        this.removeAccountFromWhitelist =
            this.removeAccountFromWhitelist.bind(this)
