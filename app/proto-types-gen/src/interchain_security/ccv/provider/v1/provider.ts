    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          message.blocksPerDistributionTransmission = longToString(reader.int64() as Long);
          continue;
        case 13:
          if (tag !== 104) {
            break;
          ...
          message.historicalEntries = longToString(reader.int64() as Long);
          continue;
        case 14:
          if (tag !== 114) {
            break;
...
export const ConsumerModificationProposal = {
  encode(message: ConsumerModificationProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConsumerModificationProposal {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChangeRewardDenomsProposal = {
  encode(message: ChangeRewardDenomsProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChangeRewardDenomsProposal {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.ibcSeqNum = longToString(reader.uint64() as Long);
          continue;
        case 4:
          if (tag !== 34) {
            break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.blocksPerEpoch = longToString(reader.int64() as Long);
          continue;
        case 11:
          if (tag !== 88) {
            break;
          ...
          message.numberOfEpochsToStartReceivingRewards = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.vscId = longToString(reader.uint64() as Long);
          continue;
        case 2:
          if (tag === 16) {
            message.unbondingOpIds.push(longToString(reader.uint64() as Long));
...
export const ExportedVscSendTimestamp = {
  encode(message: ExportedVscSendTimestamp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.chainId !== "") {
      writer.uint32(10).string(message.chainId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExportedVscSendTimestamp {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ConsumerValidator = {
  encode(message: ConsumerValidator, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConsumerValidator {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.joinHeight = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const ConsumerRewardsAllocation = {
  encode(message: ConsumerRewardsAllocation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConsumerRewardsAllocation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
