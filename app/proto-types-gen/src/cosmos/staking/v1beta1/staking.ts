...
export const Validator = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          message.unbondingOnHoldRefCount = longToString(reader.int64() as Long);
          continue;
        case 13:
          if (tag === 104) {
            message.unbondingIds.push(longToString(reader.uint64() as Long));
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      unbondingOnHoldRefCount: isSet(object.unbondingOnHoldRefCount)
        ? globalThis.String(object.unbondingOnHoldRefCount)
        : "0",
      unbondingIds: globalThis.Array.isArray(object?.unbondingIds)
        ? object.unbondingIds.map((e: any) => globalThis.String(e))
        : [],
      validatorBondShares: isSet(object.validatorBondShares) ? globalThis.String(object.validatorBondShares) : "",
      liquidShares: isSet(object.liquidShares) ? globalThis.String(object.liquidShares) : "",
    };
  },
  ...
  toJSON(message: Validator): unknown {
    ...
    if (message.unbondingIds?.length) {
      obj.unbondingIds = message.unbondingIds;
    }
    if (message.validatorBondShares !== "") {
      obj.validatorBondShares = message.validatorBondShares;
    }
    if (message.liquidShares !== "") {
...
function createBaseDelegation(): Delegation {
  return { delegatorAddress: "", validatorAddress: "", shares: "", validatorBond: false };
}
...
export const Delegation = {
  encode(message: Delegation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.validatorBond !== false) {
  ...
  fromJSON(object: any): Delegation {
    return {
      ...
      validatorBond: isSet(object.validatorBond) ? globalThis.Boolean(object.validatorBond) : false,
    };
  },
  ...
  toJSON(message: Delegation): unknown {
    ...
    if (message.validatorBond !== false) {
      obj.validatorBond = message.validatorBond;
    }
    return obj;
  },
...
export const UnbondingDelegationEntry = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.unbondingId = longToString(reader.uint64() as Long);
          continue;
        case 6:
          if (tag !== 48) {
            break;
  ...
  fromJSON(object: any): UnbondingDelegationEntry {
    return {
      ...
      unbondingId: isSet(object.unbondingId) ? globalThis.String(object.unbondingId) : "0",
      unbondingOnHoldRefCount: isSet(object.unbondingOnHoldRefCount)
        ? globalThis.String(object.unbondingOnHoldRefCount)
        : "0",
    };
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      validatorBondFactor: isSet(object.validatorBondFactor) ? globalThis.String(object.validatorBondFactor) : "",
      globalLiquidStakingCap: isSet(object.globalLiquidStakingCap)
        ? globalThis.String(object.globalLiquidStakingCap)
        : "",
      validatorLiquidStakingCap: isSet(object.validatorLiquidStakingCap)
        ? globalThis.String(object.validatorLiquidStakingCap)
        : "",
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.validatorBondFactor !== "") {
      obj.validatorBondFactor = message.validatorBondFactor;
    }
    if (message.globalLiquidStakingCap !== "") {
...
function createBaseTokenizeShareRecord(): TokenizeShareRecord {
  return { id: "0", owner: "", moduleAccount: "", validator: "" };
}
...
export const TokenizeShareRecord = {
  ...
  create<I extends Exact<DeepPartial<TokenizeShareRecord>, I>>(base?: I): TokenizeShareRecord {
    return TokenizeShareRecord.fromPartial(base ?? ({} as any));
  },
...
export const PendingTokenizeShareAuthorizations = {
  ...
  create<I extends Exact<DeepPartial<PendingTokenizeShareAuthorizations>, I>>(
    base?: I,
  ): PendingTokenizeShareAuthorizations {
    return PendingTokenizeShareAuthorizations.fromPartial(base ?? ({} as any));
  },
