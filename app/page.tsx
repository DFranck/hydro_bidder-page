...
const howHydroWorksTiles = [
  ...
  {
    title: "Lock stATOM",
    description: "Lock your stATOM for your chosen duration to get Voting Power..",
    icon: '/images/Lock_Light.svg',
  },
  {
    title: "Vote",
    description: "Use your Voting Power to choose the bet projects that need liquidity and are offering you rewards.",
    icon: '/images/Vote_Light.svg',
  },
  {
    title: "Earn Rewards",
    description: "Receive tribute each round from projects in exchange for providing them with liquidity.",
    icon: '/images/Rewards_Light.svg',
  },
  {
    title: "Renew and Top-up",
    description: "Sustain or increase your voting power by renewing or topping up your stATOM kickups",
    icon: '/images/Renew_Light.svg',
  },
  {
    title: "Repeat",
    description: "Participate in new rounds and tranches to continue earning rewards from the projects on the Hydro platform.",
...
const howItWorksForProjectsTiles = [
  {
    ...
    description: "Apply to get your project allowlisted on Hydro and start the process.",
    icon: '/images/Graphic_List.svg',
  },
  {
    title: "Offer Tribute",
    description: "Offer tribute to incentivize ATOM holders to support your project and provide liquidity.",
    icon: '/images/Graphic_Offer.svg',
  },
  {
    title: "Gain Voter Support",
    description: "Attract voter support and access liquidity to your project’s growth.",
    ...
    <main className="flex min-h-screen flex-col bg-[#080815] bg-contain bg-no-repeat bg-[url('/images/AdobeStock_633966567.png')] relative after:z-[0] after:content-[''] after:absolute after:shadow-[0_0px_100px_300px_black] after:pointer-events-none after:top-[978px] after:inset-x-0" >
      ...
      <div className="flex flex-col items-center">
        <div className="text-xl not-italic font-normal leading-[150%] z-[1]">
          Understand the step-by-step process of participating in the Hydro ecosystem.
        </div>
