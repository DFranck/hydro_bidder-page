...
OmniFlix	The p2p network for creators, DAOs, dApps & appchains to engage and educate their communities with media IP.	Confirmed	Button	More Info	https://x.com/Airdrops_one/status/1869892003464651067	FALSE
...
TFM	TFM is the "Modular Liquidity Layer" for 100+ Cosmos Chains with 4 pro trading products live.	Rumored	Text	Pending		FALSE
Eris Protocol	Liquid staking and slow burn arbitrage protocol built on Terra and Terra Classic.	Rumored	Text	Pending		FALSE
Initia	Initia is a network for interwoven rollups. Binding a highly interwoven system of modular networks through architectural ownership.	Rumored	Text	Pending		FALSE
Backbone	A multi-chain NFTfi Hub for the Cosmos, with DeFi products managed by NFT communities.	Rumored	Text	Pending		FALSE
Prysm	ICS Hub providing foundational infrastructure, enhanced connectivity, security, and scalability.	Rumored	Text	Pending		FALSE
Arkeo	Decentralized and indexed blockchain data for any chain.	Rumored	Text	Pending		FALSE
AdamantFi	Privacy-preserving liquidity protocol powered by Secret Network and ADMT	Rumored	Text	Pending		FALSE
Nomic	A Proof-of-Stake network running alongside Bitcoin to securely bring native BTC to other networks.	Rumored	Text	Pending		FALSE
Flip	Flip offers a dedicated DeFi playground tailored specifically for Degens, promising to revolutionize the trading experience.	Rumored	Text	Pending		FALSE
Toki	TOKI is a cross-chain bridge that employs multi-prover security, leveraging TEEs and ZKP for IBC.	Rumored	Text	Pending		FALSE
Movement	A next-generation blockchain network, claiming to power the fastest and most secure layer two on ethereum	Rumored	Text	Pending		FALSE
Nillion	Nillion decentralizes trust for sensitive data in the same way that blockchains decentralized transactions.	Rumored	Text	Pending		FALSE
