      ...
      <ContentContainer className="gap-6 py-6">
        ...
        >
          ...
          <StyledText variant="footnote">
            A bidder can be refunded at the end of its round, and tributes can
            be added at any time during or after the round.
          </StyledText>
          ...
          <div className="flex items-center backdrop-blur-sm">
            ...
            >
              <StyledText variant="button.secondary" as="button" tabIndex={0}>
                {requestedPreHydro ? (
                  "Pre-Hydro"
                ) : (
                  <>
