...
2. **Lock-Up and Vote**: Users lock their voting power to vote for a project.
3. **Distribution**: At the end of the voting round, tributes are distributed proportionally based on the voting power each voter locks.
