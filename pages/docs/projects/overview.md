...
| Step             | Description                                                                                                                                                                                                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bid draft        | Draft your bid using the [bid template](https://hydro.markets/docs//projects/overview#bid-template). Ensure it meets the [Whitelisting Guidelines](https://hydro.markets/docs/committee/members) authored by the Hydro Committee.                                                                 |
...
| Bid submission   | Refine the draft per copywriting standards. Finalize the bid and upload it to the Hydro smart contract as outlined in the [Bid submission](https://hydro.markets/docs/projects/bids#bid-submission) section of the bid process documentation.                                                     |
...
| Tribute Upload   | Add Tribute using the instructions in the [Tribute additions section](https://hydro.markets/docs/projects/bids#tribute-additions). (Points as tribute are managed by the Hydro team on the front-end.)                                                                                            |
...
| Deployment tests | The Hydro team and committee conduct deployment tests during the final week of the round to validate and troubleshoot liquidity deployment. More information can be found in the [Deployments process documentation](https://hydro.markets/docs/projects/deployments).                            |
...
The committee has written [guidelines for project pre-submissions](https://hydro.markets/docs/committee/performance). At launch, the strategies most likely to be allowed are Liquid Staking DEX Provision (pairing liquid ATOM with a Liquid Staking Token) and Lending (with a 60% Loan-to-Value ratio). Over time, the Hydro committee is expected to be willing to allow riskier strategies.
