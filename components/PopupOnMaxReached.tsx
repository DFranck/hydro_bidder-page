...
export function PopupOnMaxReached() {
  const { currentRoundId, currentRoundIsPilot, lockedAtomIsAtCapacityGlobal } =
    useBackendData()
  ...
  useEffect(() => {
    if (dontShowAgain || !lockedAtomIsAtCapacityGlobal) {
      return
    }

    setIsOpen(true)
  }, [dontShowAgain, lockedAtomIsAtCapacityGlobal])
