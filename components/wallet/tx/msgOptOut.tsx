...
export function SubmitOptOut() {
  ...
  const sendOptIn = async () => {
    ...
    try {
      ...
      const optInMsg = prepareOptOut(DEFAULT_VALOPER, "newchain-1");
  ...
  return (
    ...
    >
      {isReviewing ? (
        ...
        <>
          <ArrowBigLeft className="w-4 h-4 text-red-400 mr-2" />
          Validator Opt-out
        </>
      )}
    </Button>
