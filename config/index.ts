...
export const testnetChain: Chain = {
    ...
    apis: {
        ...
        grpc: [
            ...
            {
                address:
                    "https://grpc.state-sync-01.theta-testnet.polypore.xyz",
                provider: "Hypha",
            },
            {
                address:
                    "https://grpc.state-sync-02.theta-testnet.polypore.xyz",
                provider: "Hypha",
            },
        ],
    },
...
export const pionChain: Chain = {
    ...
    apis: {
        ...
        rest: [
            ...
            {
                address:
                    "https://rest.baryon-sentry-01.rs-testnet.polypore.xyz",
                provider: "Hypha",
            },
        ],
        grpc: [
    ...
    explorers: [
        {
            ...
            tx_page:
                "https://explorer.rs-testnet.polypore.xyz/pion-1/tx/${txHash}",
            account_page:
...
export const hubChain: Chain = {
    ...
    apis: {
        rpc: [
            ...
            {
                address:
                    "https://go.getblock.io/17515cb3ec0e43b7817f182e5de6066a",
    ...
    explorers: [
        ...
        },
        {
            ...
            account_page:
                "https://ezstaking.app/cosmoshub/account/${accountAddress}",
        ...
        },
        {
            ...
            account_page:
                "https://stakeflow.io/cosmos/accounts/${accountAddress}",
...
export const neutronChain = {
    ...
    explorers: [
        ...
        },
        {
            ...
            account_page:
                "https://ezstaking.app/neutron/account/${accountAddress}",
        },
        {
            kind: "WhisperNode 🤐",
...
export const NEUTRON_ASSETS = {
    ...
    assets: [
        ...
        {
            description:
                "The deflationary utility token of the Apollo DAO project",
            denom_units: [
                {
        ...
        },
        {
            ...
            extended_description:
                "Drop protocol token for the interchain liquidity",
            denom_units: [
                {
